...
class App extends Component {
  ...
  getVehicles() {
    ...
    axios
      //ask for the year
      // .get(`https://joes-autos.herokuapp.com/api/vehicles?price=30000`)
  ...
  updatePrice(priceChange, id, color) {
    // axios (PUT)
    // setState with response -> vehiclesToDisplay
    axios.put
  ...
  //OR
    ...
    // axios.put("http://joes-autos.herokuapp.com/api/vehicles?id="+ id +"&priceChange="+ priceChange)
    // axios.put(`https://joes-autos.herokuapp.com/api/vehicles?id=${id}&priceChange=${priceChange}`)
  ...
  deleteBuyer(id) {
    ...
    //Not working  because of the documentation ??
